...
const streamColor = d3.scaleOrdinal(["#fcfdbf","#f97b5d","#2f1163","#febd82","#bd3977","#842681",]);

const columnColor = d3.scaleOrdinal()
    .range(["#fcfdbf","#f97b5d","#2f1163","#febd82","#bd3977","#842681"]);
...
var originalDataGroupByState = [];

var selectedState = [];

var originalDataGroupByDate = [];
...
var currentKey = 'confirmed';

var originalGroupByStateForHist = [];

var originalGroupByStateForDeathrate = [];

var initHistData = [];

var initDeathRate = [];

var originalDataGroupByCounty = [];

var initLollipop = [];

var highState = ["New York", "New Jersey", "Illinois", "Massachusetts", "California"];
